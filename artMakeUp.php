      ...
      <section class="photos">
        <div class="container">
          <div class="grid-content">
            <?php
      $posts = get_field('photo-gal-artMake');
      if( $posts ): ?>
              ...
              ?>
               <div class="grid-content__images">
                    <img
                      ...
                      src="<?php the_field('card-artMake-big'); ?>"
                      alt="photo"
                   />
                  </div>
          <?php endforeach; ?>
      ...
      >
        <div class="container--portfolio">
          <div class="modal-fotorama">
            ...
            >
            <?php
      $posts = get_field('photo-gal-artMake', 456);
      if( $posts ): ?>
          <?php foreach( $posts as $post ): 
              ?>
               <img src="<?php the_field('card-artMake-big'); ?>" alt="photo">
          <?php endforeach; ?>
      <?php endif; ?>
            </div>
            <div class="close"></div>
    ...
    <div class="menu-mobail">
      ...
      <div class="social-mobail">
        ...
        <div class="social">
          <a
            target="_blank"
            href="<?php the_field('telegram-link', 456); ?>"
          ...
          <a
            target="_blank"
            href="<?php the_field('link-instagram',456); ?>"
            ><div class="social__item">
              <img
