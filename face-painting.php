<?php /* Template Name: face-painting */ ?>
      ...
      <section class="photos">
        <div class="container">
          <div class="grid-content">
            <?php
      $posts = get_field('photo-gal-face');
      if( $posts ): ?>
              ...
              ?>
               <div class="grid-content__images">
                    <img
                      ...
                      src="<?php the_field('card-face-big'); ?>"
                      alt="photo"
                   />
                  </div>
          <?php endforeach; ?>
      ...
      >
        <div class="container--portfolio">
          <div class="modal-fotorama">
            ...
            >
            <?php
      $posts = get_field('photo-gal-face', 530);
      if( $posts ): ?>
          <?php foreach( $posts as $post ): 
              ?>
               <img src="<?php the_field('card-face-big'); ?>" alt="photo">
          <?php endforeach; ?>
      <?php endif; ?>
            </div>
            <div class="close"></div>
    ...
    <div class="menu-mobail">
      ...
      <div class="social-mobail">
        ...
        <div class="social">
          <a
            target="_blank"
            href="<?php the_field('telegram-link', 530); ?>"
          ...
          <a
            target="_blank"
            href="<?php the_field('link-instagram', 530); ?>"
            ><div class="social__item">
              <img
